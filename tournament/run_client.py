...
class SACAgent(Agent):
    ...
    def get_step(self, observation: list[float]) -> list[float]:
        ...
        return self.actor(observation, deterministic=True).flatten().tolist()
...
def initialize_agent(agent_args: list[str]) -> Agent:
    ...
    parser.add_argument(
        ...
        "-p",
        type=str,
        default="logs/sac_hockey_strong/version_1/checkpoints/epoch=1499999-step=4500000.ckpt",
